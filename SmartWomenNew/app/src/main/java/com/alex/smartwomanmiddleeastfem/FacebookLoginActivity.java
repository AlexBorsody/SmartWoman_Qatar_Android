...
/*        Local.save(FacebookLoginActivity.this, "user_name", facebook_user_name.replace(" ", ""));
     ...
     fb_id=   Local.fetch(FacebookLoginActivity.this, "user_id");
     fb_username=   Local.fetch(FacebookLoginActivity.this,"user_name");
...
// String key = new String(Base64.encodeBytes(md.digest()));
          ...
          //  finish();
            ...
            LoginManager.getInstance().registerCallback(callbackManager, new FacebookCallback<LoginResult>() {
                ...
                public void onError(FacebookException exception) {
                    ...
                    Intent i = new Intent(FacebookLoginActivity.this,FacebookLoginActivity.class);
                    startActivity(i);
                }
            });
    ...
    Runnable SignupService = new Runnable() {
        ...
        public void run() {
            String result = "";
            try {
                result = WebServiceHandler.register_facebook(FacebookLoginActivity.this, facebook_user_id,
                        facebook_user_name);
    ...
    Runnable SignupServicee = new Runnable() {
        ...
        public void run() {
            String result = "";
            try {
                result = WebServiceHandler.signupservice(FacebookLoginActivity.this, facebook_user_name.replace(" ", ""),
                        facebook_user_id);
    ...
    Handler SignupHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            if (res.equalsIgnoreCase("true")) {
                ...
                //    e.commit();
                Intent i = new Intent(FacebookLoginActivity.this, WebViewDemoActivity.class);
